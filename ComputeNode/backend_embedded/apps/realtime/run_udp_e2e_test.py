...
def _load_desc_generator_module() -> ModuleType:
    script_path = PROJECT_ROOT / "models/model_v12.0/9_2generate_descriptive_training_data.py"
...
def main() -> int:
    ...
    ap.add_argument(
        "--offline-config",
        type=Path,
        default=PROJECT_ROOT / "apps/realtime/offline_pipeline.realtime.config.json",
        help="Offline pipeline config JSON used by apps/offline/run_offline_pipeline.py",
    )
    ap.add_argument(
        "--model-inputs-only",
        action="store_true",
    ...
    offline_cmd = [
        sys.executable,
        str(PROJECT_ROOT / "apps/offline/run_offline_pipeline.py"),
        "--config",
        str(offline_config),
        "--candidate-root",
        str(candidate_root),
    ...
    desc_cmd = [
        sys.executable,
        str(PROJECT_ROOT / "models/model_v12.0/9_2generate_descriptive_training_data.py"),
        "--in_dir",
    ...
    prompts_10_2_cmd = [
        sys.executable,
        str(PROJECT_ROOT / "models/model_v12.0/10_2descriptive_training_prompts.py"),
        "--desc_root",
        str(prompt_desc_root),
        "--out_root",
